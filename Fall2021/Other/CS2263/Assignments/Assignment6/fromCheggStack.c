...
/* Function to perform push and pop on stack */
...

{
...

    {
        ...
        printf("    STACK IMPLEMENTATION PROGRAM USING LINKED LIST \n");
...

        {
            ...
            case 2:
                ...
                // If stack is not empty(for checking if there is any elements in stack ,means having some garbage value or not)
