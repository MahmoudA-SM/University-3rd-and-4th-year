		...
		if( false == is_whitespace(input_instruction) )
		{
			 ...
			 */
		          if(input_instruction == 'u')
			 {
				 ...
				 int num;
				 scanf("%d", &num);
				 int *curr_size = &stack_current_size;
				 int *max_size = &stack_max_size;
				 push(&stack, &(*curr_size), &(*max_size), &num);
			 ...
			 else if(input_instruction == 'o')
			 {
				 ...
				 *to_return = returning;
				 int *curr_size = &stack_current_size;
				 pop(&stack, &(*curr_size), &(*to_return));
				 if(pop(stack, curr_size, to_return) == false)
				 {
					 printf("failed pop\n");
				 }
				 else
			 ...
			 else if(input_instruction == 'e')
			 {
				 ...
				 *to_return = &(returning);
				  int *curr_size = &stack_current_size;
			     peek(&stack, &(*curr_size), &(*to_return));
				 if(peek(stack, curr_size, to_return) == false)
				 {
					 printf("failed peek\n");
				 }
				 else
